<?php 
    ...
    {
        $actionUrl = "../controllers/Report.php?salaryReportTable";
    }
    ...
    <form id="modalForm" data-toggle="validator" class="modalFormSubmit" method="post" action="<?php echo $actionUrl ?>">
        ...
        <div class="form-group col-sm-3">
            ...
            <div class="input-group">
                <input class="date-picker form-control" placeholder="From Date" name="SALSTART_DT" id="START_DT" value="<?php if(isset($editAcademic)) echo $editAcademic['START_DT']?>" type="text" autocomplete="off">
        ...
        <div class="form-group col-sm-3">
            ...
            <div class="input-group">
                <input class="date-picker form-control" name="SALEND_DT" placeholder="To Date" id="END_DT" value="<?php if(isset($editAcademic)) echo $editAcademic['END_DT']?>" type="text" autocomplete="off">
                <span class="input-group-addon">
                    <i class="fa fa-calendar bigger-110"></i>
                </span>
            </div>
